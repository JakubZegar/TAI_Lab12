...
module.exports = "<selectize></selectize>\n<div class=\"component\" style=\"display: flex;flex-direction: column; align-items: center;\">\n  <div *ngFor=\"let item of items$ | filter: filterText\" style=\"width: 400px;\" >\n    <blog-item [id]=\"item.id\" [image]=\"item.url\" [text]=\"item.content\" [title]=\"item.title\" class=\"card-body\"></blog-item>\n  </div>\n</div>\n\n"
...
var AuthService = /** @class */ (function () {
    function AuthService(http) {
        this.http = http;
        this.url = 'https://tai-blog-jzegar.herokuapp.com/api';
    }
...
var DataService = /** @class */ (function () {
    function DataService(http) {
        this.http = http;
        this.url = 'https://tai-blog-jzegar.herokuapp.com';
    }
...
module.exports = __webpack_require__(/*! C:\Users\Kuba\Desktop\TAI_Lab_5-feature-server-lab10\blog\src\main.ts */"./src/main.ts");
